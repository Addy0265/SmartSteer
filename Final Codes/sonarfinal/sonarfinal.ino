...
{
     int angle;
     if(cm[0]<=100 && cm[1]<=100 && cm[2]>100)  //left and centre object
    {

        angle = 20;
        gotoangle(angle); 
    }
    if(cm[0]<=100 && cm[2]<=100 && cm[1]>100)  //right and centre object
    {
        angle = -20;
        gotoangle(angle); 
    }
    if(cm[2]<=100 && cm[1]<=100 && cm[0]>100)     // left and right object
    {
        angle = 0;
        gotoangle(angle);
      
    }
    if(cm[0]<=100 && cm[1]>100 && cm[2]>100)    //centre object
    {
        angle = 20;
        gotoangle(angle);
        // delay(250);
     }
    if(cm[1]<=100 && cm[0]>100 && cm[2]>100)     //left object
    {
        angle = 10;
    }
    if(cm[2]<=100 && cm[1]>100 && cm[0]>100)     //right object
    {
        angle = -10;
        gotoangle(angle);
        //  delay(250);
    }
    if(cm[2]<=100 && cm[1]<=100 && cm[0]<=100)    //all direction object
    {
    ...
    if(cm[2]>100 && cm[1]>100 && cm[0]>100)         //no obstacle found
    {
         angle = 0;
         gotoangle(angle);
         //delay(250);
